...
function EventListItem(props) {
    ...
    return (
        ...
        <div class="hexagon" >
            <h2 className="bg-dark text-white text-center">{props.event.name}</h2>
            <p className="text-white text-center">{props.event.user.name}</p>
            <p className="text-white text-center">{props.event.date}</p>
